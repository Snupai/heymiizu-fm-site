...
export const metadata: Metadata = {
  title: "Imprint — Miizu",
  description: "Legal notice and imprint for miizumelon.",
};
    ...
    <main className={styles.imprintMain}>
      ...
      <div className={styles.content}>
        <p className={styles.notice}>
          The person and contact details below are <u>not</u> Miizu, but only
          the website administrator. To contact Miizu directly, please use the{" "}
          <Link href="/#contact">contact form</Link> on the homepage.
          <br />
          <br />
          Die unten aufgeführte Person und die Kontaktdaten sind <u>
            nicht
          </u>{" "}
          Miizu, sondern ausschließlich der Webseiten-Verwalter / Administrator.
          Miizu selbst kann ausschließlich über das{" "}
        ...
        <section className={styles.imprintSection}>
          ...
          <p className={styles.imprintItalic}>
        ...
        <section className={styles.imprintSection}>
          ...
          <p>
            ...
            Consumer Affairs (ODR Regulation), we inform you about the existence
            of the Online Dispute Resolution Platform (ODR Platform). Consumers
            have the possibility to submit complaints to the Online Dispute
          ...
          <p>
            However, we would like to point out that we are neither willing nor
        ...
        <section className={styles.imprintSection}>
          ...
          <p>
            ...
            these pages according to § 7 Abs. 1 DDG under general laws.
            According to §§ 8 to 10 DDG, however, we as a service provider are
          ...
          <p>
            ...
            possible from the point in time at which knowledge of a specific
            infringement of the law is obtained. Upon notification of
        ...
        <section className={styles.imprintSection}>
          ...
          <p>
            ...
            einzureichen. Die dafür erforderlichen Kontaktdaten finden Sie oben
            in unserem Impressum.
          </p>
          <p>
            Es sei jedoch darauf hingewiesen, dass wir weder bereit noch
            verpflichtet sind, an Streitbeilegungsverfahren vor einer
            Verbraucherschlichtungs­stelle teilzunehmen.
          </p>
        </section>
        <section className={styles.imprintSection}>
