...
export const ProjectForm = ({
  ...
  const [aspectRatio, setAspectRatio] = useState<"16:9" | "4:3" | "3:4" | null>(
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={(value) =>
            setAspectRatio(value as "16:9" | "4:3" | "3:4")
          }
        >
          <SelectTrigger>
              ...
              if (file) {
                ...
                if (fileSizeInMB > 15) {
                  const confirmUpload = window.confirm(
                    "The video file is larger than 15MB. Do you want to continue?",
                  );
                  if (!confirmUpload) {
                    e.target.value = ""; // Clear the input
                    setVideoFile(null);
